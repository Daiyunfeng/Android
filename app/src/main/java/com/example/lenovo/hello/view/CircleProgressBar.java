package com.example.lenovo.hello.view;
 ...
 * copy http://blog.csdn.net/vv_bug/article/details/52156240
 */
public class CircleProgressBar extends ProgressBar
{
    ...
    {
        a = ValueAnimator.ofInt(0, getMax() + 1);
        a.setDuration(mTime);
    ...
    {
        a.removeListener(animatorListener); //防止动画结束运行
        a.cancel();
    }
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            switch (attr)
            {
                ...
                case R.styleable.count_down_progress_width:
                    ...
                    break;
                case R.styleable.count_down_time:
                    mTime = a.getInteger(attr, mTime);
                    Log.i(TAG, "" + mTime);
                    break;
            }
        }
